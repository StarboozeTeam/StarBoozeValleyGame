...
con.connect(function (err) {
    ...
    // If the table characters does not exists, create it
    let sql =
      "CREATE TABLE IF NOT EXISTS upgrades (id_upgrade int(5) NOT NULL, upgrade_name varchar(30) NOT NULL, upgrade_price int(10) NOT NULL, upgrade_multiplier int(5), PRIMARY KEY (id_user))";
    con.query(sql, function (err, result) {
      if (err) throw err;
